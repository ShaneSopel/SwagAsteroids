...
GameObject::GameObject()
{
    ...
    t1.loadFromFile("./../Resources/Images/rock.png");
    Animation sRock(t1, 0,0, 64, 64, 16, 0.2);

    t2.loadFromFile("./../Resources/Images/fire_blue.png");
    Animation sBullet(t2, 0,0,32,64, 16, 0.8);

    t3.loadFromFile("./../Resources/Images/Starship3.png");
    Animation sSpaceShip(t3, 40,0,52,52, 1, 0);

    t4.loadFromFile("./../Resources/Images/type_C.png");
